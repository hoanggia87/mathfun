# Vui Học Toán — Marketing & App Store Assets

Tài liệu chứa tất cả nội dung sẵn dùng cho App Store Connect (và Google Play sau này).

---

## 📝 Tên app & metadata cơ bản
...
| **Age Rating** | `4+` | Không có content nhạy cảm, quảng cáo, hay link ngoài |
| **Price** | Free | Không IAP, không ads |
...
🎮 Học mà chơi với hệ thống thưởng
• Mỗi bài đạt sao (1 ⭐ - 3 ⭐) tùy theo độ chính xác
• Quay vòng may mắn để nhận điểm thưởng
...
🎨 Thiết kế thân thiện với trẻ
• Font chữ tròn trĩnh dễ đọc
• Bàn phím số to, dễ bấm
• Hiệu ứng emoji bay khi trả lời đúng
• Phù hợp cho cả iPad và iPhone
...
📩 Phản hồi & hỗ trợ: quochuy.it.work@gmail.com
🌐 Trang web: https://hoanggia87.github.io/mathfun
```

---

## 🆕 What's New (cho mỗi bản update)

### Version 1.0.0 (lần đầu phát hành)
```
🎉 Chào mừng đến với Vui Học Toán!

Phiên bản đầu tiên với:
...
App Store yêu cầu screenshots cho ít nhất 1 size; Apple recommend nên có cho cả iPad và iPhone:

### Bắt buộc:
- **iPhone 6.5"/6.7"** (iPhone 14 Pro Max / 15 Pro Max): 1290×2796 hoặc 1284×2778, **3-10 screenshots**
...
6. Đổi quà (Rewards) — caption: "Đổi điểm lấy quà thật do bố mẹ tặng"

### Cách chụp:
1. Mở iPad simulator (đã có iPad Pro 11" M4)
2. Chỉnh device frame: Hardware → Device → iPad Pro 12.9"
3. Vào từng màn → Cmd+S để chụp screenshot
4. File lưu vào Desktop, tên `Simulator Screenshot - ...png`
5. Có thể dùng tool như `fastlane snapshot` để tự động hóa, hoặc chụp tay

---

## 🎨 App Store Preview Video (tùy chọn nhưng tăng conversion 25%)
...
Có thể dùng Screen Recording trong iPad Simulator (File → Record Screen) sau đó cắt bằng iMovie/CapCut.

---

## 🔞 Age Rating Questionnaire (Apple App Store Connect)
...
Trong "App Privacy" section, chọn:
- **Data Not Collected** ✓ (chọn lựa duy nhất)

App của bạn không thu thập bất kỳ dữ liệu nào, nên không cần kê khai gì thêm.

**Privacy Policy URL**: `https://hoanggia87.github.io/mathfun/privacy.html`

---

## 🆘 Support URL

`https://hoanggia87.github.io/mathfun/support.html`

---

## ✅ Apple App Review Checklist

Trước khi submit, đảm bảo:
- [ ] App chạy được trên iPad thật (không chỉ simulator)
- [ ] Tất cả tính năng đều hoạt động (không có "Coming soon")
- [ ] Privacy Policy URL accessible (test bằng browser)
- [ ] Support URL accessible
- [ ] Screenshots đúng kích thước, không có status bar lệch
- [ ] Bundle ID khớp với app trong App Store Connect
- [ ] Build number tăng so với bản trước (nếu là update)
- [ ] "Sign in with Apple" KHÔNG cần (vì không có login)
- [ ] Không có debug logs trong production build
- [ ] App không crash trong 30 phút sử dụng liên tục
